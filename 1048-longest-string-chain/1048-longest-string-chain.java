        ...
        for (int i = words.length - 1; i >= 0; i--) {
            ...
            for (int j = 0; j < child.length(); j++) {
                ...
                if (wordSet.contains(child.toString())) {
                    ...
                    // get the existing childLength or default of 1
                    // we don't want to overwrite this child if it is already greater
                    // otherwise, we overwrite child maxLen with parentLength + 1
